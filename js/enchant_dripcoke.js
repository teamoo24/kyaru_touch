...
enchant.LoadingScene = enchant.Class.create(enchant.Scene, {
    ...
    initialize: function() {
        ...
        var siteName = new Label();
        siteName.color = 'white';
        siteName.font = '30px sans-serif';
        siteName.moveTo(0, 30);
        siteName.text = "Enjoy with everyone"
        this.addChild(siteName);
        var siteName2 = new Label();
        siteName2.color = 'white';
        siteName2.font = '50px sans-serif';
        siteName2.moveTo(0, 70);
        siteName2.text = "Dripcoke"
        this.addChild(siteName2);
